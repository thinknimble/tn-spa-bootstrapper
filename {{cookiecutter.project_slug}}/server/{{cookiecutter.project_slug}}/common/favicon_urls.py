...
if settings.IN_STAGING or settings.IN_PROD or settings.IN_REVIEW:
    urlpatterns += [
        ...
        path(
            ...
            RedirectView.as_view(
                url=staticfiles_storage.url("favicons/android-icon-36x36.png"),
                permanent=False,
            ),
        ),
        path(
            ...
            RedirectView.as_view(
                url=staticfiles_storage.url("favicons/android-icon-48x48.png"),
                permanent=False,
            ),
        ),
        path(
            ...
            RedirectView.as_view(
                url=staticfiles_storage.url("favicons/android-icon-72x72.png"),
                permanent=False,
            ),
        ),
        path(
            ...
            RedirectView.as_view(
                url=staticfiles_storage.url("favicons/android-icon-96x96.png"),
                permanent=False,
            ),
        ),
        path(
            ...
            RedirectView.as_view(
                url=staticfiles_storage.url("favicons/android-icon-144x144.png"),
                permanent=False,
            ),
        ),
        path(
