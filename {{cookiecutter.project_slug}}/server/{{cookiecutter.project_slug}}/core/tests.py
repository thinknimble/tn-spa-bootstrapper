...
class TestPreviewTemplateView:
    ...
    def test_enabled_if_debug(self, client):
        with mock.patch("{{ cookiecutter.project_slug }}.views.render", return_value=Response()) as mocked_render:
    ...
    def test_parse_value_with_model(self):
        with mock.patch("{{ cookiecutter.project_slug }}.views.apps") as mock_apps:
