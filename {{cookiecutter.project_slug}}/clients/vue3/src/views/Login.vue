<template>
  <div class="form-container">
    ...
    <form class="flex flex-col items-center" @submit.prevent="attemptLogin()">
      ...
      <button
        class="group relative flex w-full justify-center rounded-md border border-transparent bg-violet-300 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
