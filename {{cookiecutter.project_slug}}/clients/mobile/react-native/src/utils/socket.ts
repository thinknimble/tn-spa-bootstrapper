...
export const getSocketProtocol = (url: { protocol: string }) => {
  return url.protocol === 'https:' ? wsProtocolEnum.wss : wsProtocolEnum.ws
}
...
export const connectSocket = ({
  ...
  const ws = new WebSocket(wsUrl) as WebSocket & { binaryType: string }
