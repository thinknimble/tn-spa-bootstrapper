...
def set_django_secret_key(file_path, value=None):
...
def set_keys_in_envs():
    ...
    set_django_secret_key(env_file_path, value=django_secret_key)
    set_django_secret_key(pull_request_template_path, value=django_secret_key)
    set_django_secret_key(cookie_cutter_settings_path, value=django_secret_key)
