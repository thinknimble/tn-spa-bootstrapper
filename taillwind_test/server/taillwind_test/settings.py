...
if IN_DEV:
    SERVER_EMAIL = "taillwind-test Development <noreply-dev@taillwind_test.com>"
elif IN_STAGING:
    SERVER_EMAIL = "taillwind-test Staging <noreply-staging@taillwind_test.com>"
else:
    SERVER_EMAIL = "taillwind-test <noreply@taillwind_test.com>"
...
INSTALLED_APPS = [
    ...
    "SCHEMA": "taillwind_test.core.schema.schema",
    "MIDDLEWARE": [
...
ROOT_URLCONF = "taillwind_test.urls"
...
WSGI_APPLICATION = "taillwind_test.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "taillwind_test.core.pagination.PageNumberPagination",
...
if config("USE_AWS_STORAGE", cast=bool, default=False):
    ...
    DEFAULT_FILE_STORAGE = "taillwind_test.utils.storages.PrivateMediaStorage"
    STATICFILES_STORAGE = "taillwind_test.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "taillwind_test.request": {"handlers": [], "level": "INFO", "propagate": True},
        "taillwind_test.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["taillwind_test"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://taillwind_test-staging.herokuapp.com", "https://taillwind_test.herokuapp.com"]
