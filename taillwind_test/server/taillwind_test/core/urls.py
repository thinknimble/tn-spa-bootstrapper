...
from taillwind_test.core import views as core_views
...
schema_view = get_schema_view(
    openapi.Info(
        title="taillwind-test API",
        default_version="1.0",
        description="taillwind-test Docs",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="support@taillwind_test.com"),
