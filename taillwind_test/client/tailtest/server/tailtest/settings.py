...
if IN_DEV:
    SERVER_EMAIL = "tailtest Development <noreply-dev@tailtest.com>"
elif IN_STAGING:
    SERVER_EMAIL = "tailtest Staging <noreply-staging@tailtest.com>"
else:
    SERVER_EMAIL = "tailtest <noreply@tailtest.com>"
...
INSTALLED_APPS = [
    ...
    "SCHEMA": "tailtest.core.schema.schema",
    "MIDDLEWARE": [
...
WSGI_APPLICATION = "tailtest.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "tailtest.core.pagination.PageNumberPagination",
...
if config("USE_AWS_STORAGE", cast=bool, default=False):
    ...
    DEFAULT_FILE_STORAGE = "tailtest.utils.storages.PrivateMediaStorage"
    STATICFILES_STORAGE = "tailtest.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "tailtest.request": {"handlers": [], "level": "INFO", "propagate": True},
        "tailtest.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["tailtest"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://tailtest-staging.herokuapp.com", "https://tailtest.herokuapp.com"]
